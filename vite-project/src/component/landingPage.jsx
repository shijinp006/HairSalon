    ...
    return (
        ...
        "
            ...
            >
                ...
                <div className="relative z-10 px-4 md:px-8 lg:px-20">
                    {/* Newsletter */}
                    <div className="py-12 border-b border-white/20">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4">
                                ...
                                <h2
                                    className="text-[#E58A78] text-2xl uppercase"
                                    style={{ fontFamily: "Oswald, sans-serif" }}
                                >
                                    The Style Loft
                                </h2>
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full lg:w-auto">
                                <h3
                                    className="text-white uppercase text-2xl text-center md:text-left"
                                    style={{ fontFamily: "Oswald, sans-serif" }}
                                >
                                    Subscribe
                                    <br />
            ...
            "
                    ...
                    {/* Footer Content */}
                    <div className="py-14 grid md:grid-cols-3 lg:grid-cols-4 gap-10 text-center md:text-left">
                        {/* Contact */}
                        <div>
                            <h3
                                className="text-white text-3xl uppercase mb-8"
                                style={{ fontFamily: "Oswald, sans-serif" }}
                            >
                                Contact Us
                            </h3>
                            ...
                            <div className="space-y-5 text-white/90 text-sm">
                                ...
                                <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start gap-3">
                                    <Mail className="text-[#E58A78]" />
                                    <p>info@styleloft.com</p>
                                </div>

                                <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start gap-3">
                                    <Phone className="text-[#E58A78]" />
                                    <p>070 4531 9507</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-white/90 flex flex-col items-center md:items-start">
                                {[
                                    "Hair Cutting",
                                    "Hair Styling",
                                    "Detan & Bleach",
              ...
              "
                                    >
                                        ...
                                        <div>
                                            <p className="text-[#E58A78] text-sm">
                                                April 10, 2024
                                            </p>

                                            <h4 className="text-white leading-snug">
                    ...
                    <div className="border-t border-white/20 py-6 text-center text-white/70">
                        © 2025 The Style Loft. All Rights Reserved.
                    </div>
                </div>
            </motion.footer>
        </div>
